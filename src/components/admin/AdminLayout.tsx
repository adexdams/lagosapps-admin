    ...
    <div className="min-h-screen bg-[#F5F6FA] flex">
      ...
      <aside className="hidden md:flex flex-col w-[260px] bg-white border-r border-[#E8ECF1] flex-shrink-0 fixed inset-y-0 left-0 z-40">
        ...
        <div className="px-6 py-4 border-t border-[#E8ECF1] space-y-2">
          ...
          <button onClick={logout} className="flex items-center gap-2 text-[13px] text-[#94A3B8] hover:text-[#DC2626] transition-colors cursor-pointer w-full">
      ...
      <div className="flex-1 md:ml-[260px] flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-[#E8ECF1] px-4 md:px-8 h-16 flex items-center gap-4">
          ...
          {/* Logout */}
          <button onClick={logout} className="hidden sm:flex items-center gap-1 text-sm text-[#94A3B8] hover:text-[#DC2626] cursor-pointer transition-colors" title="Sign out">
            <span className="material-symbols-outlined text-[18px]">logout</span>
          </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[11px] text-[#94A3B8]">{user?.role?.replace("_", " ").replace(/\b\w/g, (c) => c.toUpperCase()) || "Admin"}</p>
            </div>
          </div>
        </header>
